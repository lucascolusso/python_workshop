...
# studied!
url_catscan = 'http://tools.wmflabs.org/catscan2/catscan2.php?depth=10&categories=%(my_category)s&doit=1&format=json'
url_catscan = url_catscan % {'category' : my_category}
...
for article in articles:
    ...
    if ["Lord Opeth", "Serendipodous", "Fbv65edel", "Faithlessthewonderboy", "ClueBot NG"] == "user":

        # first grab tht title
        title = article["a"]["title"]

        # get the list of revisions from our function and then iterating through it printing it out
